Feature: Orion Finance Finco Test Scenarios - TEMİNAT MEKTUBU EKLEME VE SİLME KONTROLÜ

  #1.)Başvuru Oluşturma
  #2.)Teminat Ekleme ve Silme
  #3.)Kredi İptali
  #4.)Kredi İptal Onayı
  ...
  @TeminatEklemeSilme
  Scenario: TEMİNAT MEKTUBU EKLEME VE SİLME:
