Feature: Orion Finance Finco Test Scenarios - GKTİ BAŞVURU

  #1.)Fiyatlama Güncelleme
  #2.)Fiyatlama Güncelleme Onayı
  #3.)Başvuru Giriş
  #4.)Başvuru Değerlendirme
  ...
  Scenario: GKTİ Başvuru: TC001 -
    ...
    #Fiyatlama Güncelleme Onayı - 2Scenario:
    ...
    #Başvuru Değerlendirme - 4Scenario:
    And I wait close system button element 30 seconds at index 1
    When I click element: close system button at index 1
    Given Open the https://orion-finance-finco-amtest.apps.dvt-fcloud.vfinans.local/ URL
    Then I see login page
    ...
    And I wait confirmed amount text area element 45 seconds at index 1
