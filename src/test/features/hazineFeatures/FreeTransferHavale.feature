Feature: Orion Finance Finco Test Scenarios / Test Cases for Treasury
  ...
  #1.) Serbest Transfer Havale

  @Treasury
  Scenario: Free Transfer Havale
    ...
    And I click element: Free transfer operation code havale at index 1
    ...
    And I click element: Free transfer havale button at index 1
