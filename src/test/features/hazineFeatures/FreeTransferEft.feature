Feature: Orion Finance Finco Test Scenarios / Test Cases for Treasury
  ...
  #1.) Serbest Transfer Eft

  @Treasury
  Scenario: Free Transfer Eft
    ...
    And I click element: Free transfer operation code eft at index 1
    ...
    And I click element: Free transfer eft button at index 1
