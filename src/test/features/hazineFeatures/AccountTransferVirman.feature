Feature: Orion Finance Finco Test Scenarios / Test Cases for Treasury
  ...
  Scenario: Account Transfer Virman
   #Yeni Parametre Tanımlama
    ...
    When I click element: Account transfer virman bank at index 1
    And I click element: Account transfer receiving bank search button at index 1
    When I click element: Account transfer virman bank option at index 1
    ...
    And I wait Account transfer virman button element 30 seconds at index 1
    And I click element: Account transfer virman button at index 1
