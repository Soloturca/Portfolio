Feature: Orion Finance Finco Test Scenarios - YENİ TARAF TANIMLAMA

  #1.)YENİ TARAF TANIMLAMA
  #2.)yeni TARAF tanımlama onay
  ...
  @YeniTarafTanımlama
  Scenario: YENİ TARAF TANIMLAMA LOGİN:

    #Yeni taraf tanımlma - 1Scenario:
    ...
    And I wait type selection element 30 seconds at index 1
    Then I select element: "PERSONEL" under type selection at index 1
    ...
    #yeni taraf talep onayı - 2Scenario:
    ...
    Then I need to check area verify by warning check at index 1 contains "Taraf Tanımlama/Güncelleme işlemi onaylandı."
