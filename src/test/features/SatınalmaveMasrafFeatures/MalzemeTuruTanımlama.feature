Feature: Orion Finance Finco Test Scenarios - MALZEME TÜRÜ TANIMLAMA

  #1.)YENİ MALZEME turu TANIMLAMA
  #2.)malzeme turu tanımlama onay
  ...
  @MalzemeTuruTanımlama
  Scenario: MALZEME TÜRÜ TANIMLAMA LOGİN:

    #Malzeme turu tanımlama - 1Scenario:
    ...
    Then I click element: commission bank name search at index 1
    And I wait role button element 30 seconds at index 7
    Then I click element: role button at index 7
    When I click element: select first line at index 22
    ...
    #Malzeme turu tanımlama  talep onayı - 2Scenario:
    ...
    Then I need to check area verify by warning check at index 1 contains "Malzeme Türü Tanımlama/Güncelleme işlemi onaylandı."
