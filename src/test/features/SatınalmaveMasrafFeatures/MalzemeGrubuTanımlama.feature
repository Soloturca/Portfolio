Feature: Orion Finance Finco Test Scenarios - MALZEME GRUBU TANIMLAMA

  #1.)YENİ MALZEME GRUBU TANIMLAMA
  #2.)malzeme grubu tanımlama onay
  ...
  @MalzemeGrubuTanımlama
  Scenario: MALZEME GRUBU TANIMLAMA LOGİN:

    #Malzeme grubu tanımlama - 1Scenario:
    ...
    #Malzeme grubu tanımlama  talep onayı - 2Scenario:
    ...
    Then I need to check area verify by warning check at index 1 contains "Malzeme Grubu Tanımlama/Güncelleme işlemi onaylandı."
