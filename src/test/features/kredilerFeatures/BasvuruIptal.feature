Feature: Orion Finance Finco Test Scenarios - 012.ÖN DEĞERLENDİRMEDEN GEÇEN KREDİ BAŞVURUSUNUN İPTALİ
  ...
  Scenario: Başvuru İlerletme: TC001
    ...
    Then I enter "4814" text to trade registration no text area at index 1
  ...
  Scenario: Başvuru İptal: TC002
    ...
    Then I enter "12231" text to credit application observation and report customer no button at index 1
