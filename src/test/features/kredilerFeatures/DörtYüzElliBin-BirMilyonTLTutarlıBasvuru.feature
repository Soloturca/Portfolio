Feature: Orion Finance Finco Test Scenarios - 014.DörtYüzElliBin-BirMilyon Tl Tutarlı Kredinin Onayı
  ...
  Scenario: Başvuru Giriş: TC001
    ...
    Then I enter "500000" text to invoice amount/product quantity text area at index 1
    Then I enter "1" text to invoice amount/product quantity piece text area at index 1
    Then I enter "500000" text to credit amount text area at index 1
  ...
  Scenario: Başvuru Değerlendirme: TC002
    ...
    And I wait current highlight element 30 seconds at index 1
    Then I enter "500000" text to current highlight at index 1
