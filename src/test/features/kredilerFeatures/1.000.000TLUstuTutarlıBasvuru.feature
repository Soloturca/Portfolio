Feature: Orion Finance Finco Test Scenarios - 015.GKTİ BAŞVURU-1.000.000 Tl Üstü Tutarlı Kredinin Onayı
  ...
  Scenario: Başvuru Giriş: TC001
    ...
    Then I enter "11772" text to customer no-new application text area at index 1
    ...
    And I click element: kkdf free at index 1
    ...
    Then I enter "1000000" text to invoice amount/product quantity text area at index 1
    Then I enter "1" text to invoice amount/product quantity piece text area at index 1
    Then I enter "1000000" text to credit amount text area at index 1
  ...
  Scenario: Başvuru Değerlendirme: TC002
    ...
    And I wait current highlight element 30 seconds at index 1
    Then I enter "1000000" text to current highlight at index 1
  ...
  Scenario: 1.000.000 Tl Üstü Tutarlı Kredinin Onayı: TC003
    ...
    Then I enter "90030" text to username text area at index 1
    Then I enter "1" text to password text area at index 1
    And I wait login button element 30 seconds at index 1
    When I click element: login button at index 1
    Then I see home page
    ...
    Then I enter "90010" text to username text area at index 1
    Then I enter "1" text to password text area at index 1
    And I wait login button element 30 seconds at index 1
    When I click element: login button at index 1
    Then I see home page
