...
Feature: Postpaid Feature
  ...
  Scenario: Postpaid Public Payment Fatura
    ...
    And I wait gsm continue button element 30 seconds at index 1
    When I click element: gsm continue button at index 1
    Given I scroll and see element: payment continue button at index 1
    And I wait payment continue button element 30 seconds at index 1
    ...
    And I wait 3D secure okay button element 30 seconds at index 1
  ...
  Scenario: Postpaid Yanimda Web Masterpass Fatura Ödeme
    ...
    Then I need to just wait
    Then I execute db queries for pay the bill
    And I wait pay bill element 30 seconds at index 1
    When I click element: pay bill at index 1
    Then I need to just wait
    And I wait yeni fatura ode button element 30 seconds at index 1
    When I click element: yeni fatura ode button at index 1
    And I wait pay bill page tel text area element 30 seconds at index 1
    ...
    And I wait master pass card save button element 30 seconds at index 1
    When I click element: master pass card save button at index 1
    And I wait master pass card name element 30 seconds at index 1
  ...
  Scenario: Postpaid Yanimda Web Ek Paket Al
    ...
    Then I see loginYanimdaWeb page
    Then I need to just wait
    And I wait ek paket al button element 30 seconds at index 1
    When I click element: ek paket al button at index 1
    Then I need to just wait
    And I wait option dropdown element 30 seconds at index 1
    When I click element: option dropdown at index 1
    Then I click element: option dropdown select at index 1
    And I wait hemen al button element 30 seconds at index 1
    When I click element: hemen al button at index 1
    Then I need to just wait
    And I wait paket satin al button element 30 seconds at index 1
  ...
  Scenario: Postpaid Yanimda Web Kalan Kullanim Görüntüleme
    ...
    Then I need to just wait
    And I wait tarifem ve kalan kullanimlarim button element 30 seconds at index 1
    When I click element: tarifem ve kalan kullanimlarim button at index 1
    And I wait kalan kullanimlarim text element 30 seconds at index 1
    #gb
    ...
    Then I need to just wait
    And I wait logout list element 30 seconds at index 1
    When I click element: logout list at index 1
    Then I need to just wait
    And I wait logout element 30 seconds at index 1
    When I click element: logout at index 1
    Then I need to just wait
    And I wait logout popup element 30 seconds at index 1
