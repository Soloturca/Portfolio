Feature: Orion Finance Finco Test Scenarios - DEKONT GÖZLEM GECİKMELİ ÖDENMİŞ

  #1.)DEKONT GÖZLEM GECİKMELİ ÖDENMİŞ
  ...
  @DekontGozlemGecikmeliOdenmis
  Scenario: DEKONT GÖZLEM GECİKMELİ ÖDENMİŞ LOGİN:

    #Dekont Gözlem Gecikmeli Ödenmiş - 1Scenario:
    ...
    Then I enter "917" text to receipt no area at index 1
    And I wait receipt date element 30 seconds at index 1
    When I clear text to receipt date at index 1
    Then I enter "18082022" text to receipt date at index 1
    Then I clear text to receipt date at index 2
    Then I enter "18082022" text to receipt date at index 2
