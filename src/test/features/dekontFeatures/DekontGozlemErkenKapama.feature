Feature: Orion Finance Finco Test Scenarios - DEKONT GÖZLEM ERKEN KAPAMA

  #1.)DEKONT GÖZLEM ERKEN KAPAMA
  ...
  @DekontGozlemErkenKapama
  Scenario: DEKONT GÖZLEM ERKEN KAPAMA LOGİN:

    #Dekont Gözlem Erken Kapama - 1Scenario:
    ...
    Then I enter "913" text to receipt no area at index 1
    And I wait receipt date element 30 seconds at index 1
    When I clear text to receipt date at index 1
    Then I enter "17082022" text to receipt date at index 1
    Then I clear text to receipt date at index 2
    Then I enter "17082022" text to receipt date at index 2
