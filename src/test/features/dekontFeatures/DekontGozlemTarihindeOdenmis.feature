Feature: Orion Finance Finco Test Scenarios - DEKONT GÖZLEM TARİHİNDE ÖDENMİŞ

  #1.)DEKONT GÖZLEM TARİHİNDE ÖDENMİŞ
  ...
  @DekontGozlemTarihindeOdenmis
  Scenario: DEKONT GÖZLEM TARİHİNDE ÖDENMİŞ LOGİN:

    #Dekont Gözlem Tarihinde Ödenmiş - 1Scenario:
    ...
    Then I enter "909" text to receipt no area at index 1
    And I wait receipt date element 30 seconds at index 1
    When I clear text to receipt date at index 1
    Then I enter "10082022" text to receipt date at index 1
    Then I clear text to receipt date at index 2
    Then I enter "10082022" text to receipt date at index 2
