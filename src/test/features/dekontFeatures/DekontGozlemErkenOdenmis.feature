Feature: Orion Finance Finco Test Scenarios - DEKONT GÖZLEM ERKEN ÖDENMİŞ

  #1.)DEKONT GÖZLEM ERKEN ÖDENMİŞ
  ...
  @DekontGozlemErkenOdenmis
  Scenario: DEKONT GÖZLEM ERKEN ÖDENMİŞ LOGİN:

    #Dekont Gözlem Erken Ödenmiş - 1Scenario:
    ...
    Then I enter "906" text to receipt no area at index 1
