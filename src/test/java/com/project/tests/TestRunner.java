...
@CucumberOptions(
        ...
        tags = {"@BireyselKrediBasvuru, @teminat, @TahsisdenIadeBasvuruVeIptal, @TeminatEklemeSilme, @BasvuruIptal, @FiyatlamaEsit, @FiyatlamaEsnek, @FiyatlamaGozlem, @GKTIMevcutBasvuru, @GozlemVeRapor, @KefilEklemeSilme, @MevcutEsitFiyatlama, @MevcutEsnekFiyatlama, @bank, @KomisyonOdeme, @GiderOdeme, @SatınAlmaTalep"},
